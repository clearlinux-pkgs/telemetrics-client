...
Version  : 2.3.0
Release  : 107
URL      : https://github.com/clearlinux/telemetrics-client/releases/download/v2.3.0/telemetrics-client-2.3.0.tar.gz
Source0  : https://github.com/clearlinux/telemetrics-client/releases/download/v2.3.0/telemetrics-client-2.3.0.tar.gz
...
%prep
%setup -q -n telemetrics-client-2.3.0
cd %{_builddir}/telemetrics-client-2.3.0
%patch1 -p1
%patch2 -p1
%patch3 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1573586043
...
cp %{_builddir}/telemetrics-client-2.3.0/LICENSE.LGPL-2.1 %{buildroot}/usr/share/package-licenses/telemetrics-client/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
