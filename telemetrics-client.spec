...
Version  : 1.12.4
Release  : 82
URL      : https://github.com/clearlinux/telemetrics-client/releases/download/v1.12.4/telemetrics-client-1.12.4.tar.gz
Source0  : https://github.com/clearlinux/telemetrics-client/releases/download/v1.12.4/telemetrics-client-1.12.4.tar.gz
...
%prep
%setup -q -n telemetrics-client-1.12.4
...
export LANG=C
export SOURCE_DATE_EPOCH=1498242165
export AR=gcc-ar
