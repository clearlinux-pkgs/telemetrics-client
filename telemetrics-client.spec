...
Version  : 1.15.1
Release  : 91
URL      : https://github.com/clearlinux/telemetrics-client/releases/download/v1.15.1/telemetrics-client-1.15.1.tar.gz
Source0  : https://github.com/clearlinux/telemetrics-client/releases/download/v1.15.1/telemetrics-client-1.15.1.tar.gz
...
%prep
%setup -q -n telemetrics-client-1.15.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1521036186
export AR=gcc-ar
