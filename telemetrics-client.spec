...
Version  : 1.14.2
Release  : 86
URL      : https://github.com/clearlinux/telemetrics-client/releases/download/v1.14.2/telemetrics-client-1.14.2.tar.gz
Source0  : https://github.com/clearlinux/telemetrics-client/releases/download/v1.14.2/telemetrics-client-1.14.2.tar.gz
...
%prep
%setup -q -n telemetrics-client-1.14.2
...
export LANG=C
export SOURCE_DATE_EPOCH=1508189073
export AR=gcc-ar
