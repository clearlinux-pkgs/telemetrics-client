...
Version  : 2.3.2
Release  : 109
URL      : https://github.com/clearlinux/telemetrics-client/releases/download/v2.3.2/telemetrics-client-2.3.2.tar.gz
Source0  : https://github.com/clearlinux/telemetrics-client/releases/download/v2.3.2/telemetrics-client-2.3.2.tar.gz
...
%prep
%setup -q -n telemetrics-client-2.3.2
cd %{_builddir}/telemetrics-client-2.3.2
%patch1 -p1
%patch2 -p1
%patch3 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576697991
...
cp %{_builddir}/telemetrics-client-2.3.2/LICENSE.LGPL-2.1 %{buildroot}/usr/share/package-licenses/telemetrics-client/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
