...
Version  : 2.0.0
Release  : 97
URL      : https://github.com/clearlinux/telemetrics-client/releases/download/v2.0.0/telemetrics-client-2.0.0.tar.gz
Source0  : https://github.com/clearlinux/telemetrics-client/releases/download/v2.0.0/telemetrics-client-2.0.0.tar.gz
...
%prep
%setup -q -n telemetrics-client-2.0.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1536703178
export AR=gcc-ar
