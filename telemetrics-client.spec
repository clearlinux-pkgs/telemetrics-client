...
Version  : 2.3.1
Release  : 108
URL      : https://github.com/clearlinux/telemetrics-client/releases/download/v2.3.1/telemetrics-client-2.3.1.tar.gz
Source0  : https://github.com/clearlinux/telemetrics-client/releases/download/v2.3.1/telemetrics-client-2.3.1.tar.gz
...
%prep
%setup -q -n telemetrics-client-2.3.1
cd %{_builddir}/telemetrics-client-2.3.1
%patch1 -p1
%patch2 -p1
%patch3 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1574794042
...
cp %{_builddir}/telemetrics-client-2.3.1/LICENSE.LGPL-2.1 %{buildroot}/usr/share/package-licenses/telemetrics-client/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
