...
Version  : 1.12.1
Release  : 78
URL      : https://github.com/clearlinux/telemetrics-client/releases/download/v1.12.1/telemetrics-client-1.12.1.tar.gz
Source0  : https://github.com/clearlinux/telemetrics-client/releases/download/v1.12.1/telemetrics-client-1.12.1.tar.gz
...
%prep
%setup -q -n telemetrics-client-1.12.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1495824134
export AR=gcc-ar
