...
Version  : 1.15.0
Release  : 90
URL      : https://github.com/clearlinux/telemetrics-client/releases/download/v1.15.0/telemetrics-client-1.15.0.tar.gz
Source0  : https://github.com/clearlinux/telemetrics-client/releases/download/v1.15.0/telemetrics-client-1.15.0.tar.gz
...
%prep
%setup -q -n telemetrics-client-1.15.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1520895592
export AR=gcc-ar
