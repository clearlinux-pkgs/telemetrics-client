...
Version  : 1.13.0
Release  : 83
URL      : https://github.com/clearlinux/telemetrics-client/releases/download/v1.13.0/telemetrics-client-1.13.0.tar.gz
Source0  : https://github.com/clearlinux/telemetrics-client/releases/download/v1.13.0/telemetrics-client-1.13.0.tar.gz
...
%prep
%setup -q -n telemetrics-client-1.13.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1499282544
export AR=gcc-ar
