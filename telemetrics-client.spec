...
Version  : 1.16.2
Release  : 95
URL      : https://github.com/clearlinux/telemetrics-client/releases/download/v1.16.2/telemetrics-client-1.16.2.tar.gz
Source0  : https://github.com/clearlinux/telemetrics-client/releases/download/v1.16.2/telemetrics-client-1.16.2.tar.gz
...
%prep
%setup -q -n telemetrics-client-1.16.2
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1532727946
export AR=gcc-ar
