...
Version  : 1.9.0
Release  : 60
URL      : https://github.com/clearlinux/telemetrics-client/releases/download/v1.9.0/telemetrics-client-1.9.0.tar.gz
Source0  : https://github.com/clearlinux/telemetrics-client/releases/download/v1.9.0/telemetrics-client-1.9.0.tar.gz
...
%prep
%setup -q -n telemetrics-client-1.9.0
