...
Version  : 1.14.1
Release  : 85
URL      : https://github.com/clearlinux/telemetrics-client/releases/download/v1.14.1/telemetrics-client-1.14.1.tar.gz
Source0  : https://github.com/clearlinux/telemetrics-client/releases/download/v1.14.1/telemetrics-client-1.14.1.tar.gz
...
%prep
%setup -q -n telemetrics-client-1.14.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1505498432
export AR=gcc-ar
