...
Version  : 2.0.1
Release  : 98
URL      : https://github.com/clearlinux/telemetrics-client/releases/download/v2.0.1/telemetrics-client-2.0.1.tar.gz
Source0  : https://github.com/clearlinux/telemetrics-client/releases/download/v2.0.1/telemetrics-client-2.0.1.tar.gz
...
%prep
%setup -q -n telemetrics-client-2.0.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1537892154
export AR=gcc-ar
