...
Version  : 1.14.0
Release  : 84
URL      : https://github.com/clearlinux/telemetrics-client/releases/download/v1.14.0/telemetrics-client-1.14.0.tar.gz
Source0  : https://github.com/clearlinux/telemetrics-client/releases/download/v1.14.0/telemetrics-client-1.14.0.tar.gz
...
%prep
%setup -q -n telemetrics-client-1.14.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1504882950
export AR=gcc-ar
