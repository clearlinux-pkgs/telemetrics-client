...
Version  : 2.2.1
Release  : 101
URL      : https://github.com/clearlinux/telemetrics-client/releases/download/v2.2.1/telemetrics-client-2.2.1.tar.gz
Source0  : https://github.com/clearlinux/telemetrics-client/releases/download/v2.2.1/telemetrics-client-2.2.1.tar.gz
...
%prep
%setup -q -n telemetrics-client-2.2.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1564849466
