...
Version  : 1.12.3
Release  : 81
URL      : https://github.com/clearlinux/telemetrics-client/releases/download/v1.12.3/telemetrics-client-1.12.3.tar.gz
Source0  : https://github.com/clearlinux/telemetrics-client/releases/download/v1.12.3/telemetrics-client-1.12.3.tar.gz
...
%prep
%setup -q -n telemetrics-client-1.12.3
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1497998711
export AR=gcc-ar
